...
parser.add_argument("--decaystart_epochs", type=int, default=300, help="Number of training epochs When training resume")
parser.add_argument("--lr", type=float, default=1e-4, help="Initial learning rate")
parser.add_argument("--step", type=int, default=100, help="When to decay learning rate; should be less than epochs")
